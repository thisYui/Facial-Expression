...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{L{3.2cm} X C{2.4cm}}
        \toprule
        \textbf{Thành viên} & \textbf{Nhiệm vụ phụ trách} & \textbf{Tỷ lệ hoàn thành} \\
        \midrule
        Nguyễn Hưng Thịnh & \textit{[Điền nhiệm vụ]} & \textit{[\%]} \\
        Lê Thành Công & \textit{[Điền nhiệm vụ]} & \textit{[\%]} \\
        Lê Thượng Đế & \textit{[Điền nhiệm vụ]} & \textit{[\%]} \\
        Châu Văn Minh Khoa & \textit{[Điền nhiệm vụ]} & \textit{[\%]} \\
        Phan Ngọc Quân & \textit{[Điền nhiệm vụ]} & \textit{[\%]} \\
        Hoàng Tiến Huy & Đọc hiểu mã nguồn, giải thích cơ sở thiết kế, thực hiện demo nhận diện cảm xúc & 100\% \\
        \bottomrule
    \end{tabularx}
\end{table}
